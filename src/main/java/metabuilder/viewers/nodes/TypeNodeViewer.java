...
import metabuilder.viewers.LineStyle;
...
import metabuilder.viewers.ViewUtils;
...
public class TypeNodeViewer extends AbstractNodeViewer
{
	...
	{
		assert pNode != null;
		if(pNode instanceof ClassNode) {
			ClassNode npNode = (ClassNode) pNode;
			if(npNode.getIsAbstract()) {
				return "\u00ABabstract\u00BB\n" + pNode.getName();
			}
		}
